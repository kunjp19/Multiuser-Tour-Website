...
function Home() {
    return (
        <div className="center-container">
            <img className="center-image" src={paddleboard2Image} alt="Paddleboard" />
            <p className="center-text">
                Hello, We are from <b>Paddleboard Tour</b>. This one has to be the most important requirement. Otherwise,
